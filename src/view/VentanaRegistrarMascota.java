 ...
 * @author 12212
 */
public class VentanaRegistrarMascota extends javax.swing.JFrame {
    private String ss;
    /**
     * Creates new form NewJFrame
     */
    public VentanaRegistrarMascota(String s) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRegistrarMascota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaRegistrarMascota("-").setVisible(true);
            }
        });
    }
